...
paths:
  /tournaments/{tournament}/matches/{match_id}/attachments/{attachment_id}.json:
    get:
      summary: Get a match attachment
      deprecated: true
      description: Retrieve a single match attachment record.
      tags:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1113893/apis/api-23832714-run
components:
  schemas: {}
  securitySchemes:
    api_key:
