  ...
  /tournaments/{tournament}/open_for_predictions.json:
    post:
      ...
      description: >-
        ...
        predictions, match records will be persisted, so participant additions
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1113893/apis/api-23827372-run
components:
  schemas: {}
  securitySchemes:
    api_key:
