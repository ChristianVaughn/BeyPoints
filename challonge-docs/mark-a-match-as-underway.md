...
info:
  ...
  version: 1.0.0
paths:
  /tournaments/{tournament}/matches/{match_id}/mark_as_underway.json:
    post:
      summary: Mark a match as underway
      deprecated: true
      description: >-
        Sets "underway_at" to the current time and highlights the match in the
        bracket
      tags:
            ...
            application/json:
              ...
              example:
                match:
                  ...
                  underway_at: '2025-11-05T18:51:44.420+00:00'
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1113893/apis/api-23832661-run
components:
  schemas: {}
  securitySchemes:
    api_key:
