...
info:
  ...
  version: 1.0.0
paths:
  /tournaments/{tournament}/matches/{match_id}/attachments.json:
    get:
      summary: List a match's attachments
      deprecated: true
      description: Retrieve a match's attachments.
      tags:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1113893/apis/api-23832672-run
components:
  schemas: {}
  securitySchemes:
    api_key:
