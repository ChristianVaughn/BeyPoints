...
info:
  ...
  version: 1.0.0
paths:
  /tournaments/{tournament}/participants/{participant_id}/undo_check_in.json:
    post:
      summary: Undo check-in for a participant
      deprecated: true
      description: >-
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1113893/apis/api-23832014-run
components:
  schemas: {}
  securitySchemes:
    api_key:
