...
info:
  ...
  version: 1.0.0
paths:
  /tournaments/{tournament}/participants/{participant_id}.json:
    delete:
      summary: Delete/deactivate a participant
      deprecated: true
      description: >-
        ...
        participant inactive, automatically forfeiting his/her remaining
        matches.
      tags:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1113893/apis/api-23832019-run
components:
  schemas: {}
  securitySchemes:
    api_key:
