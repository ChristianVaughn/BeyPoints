...
paths:
  /tournaments/{tournament}/participants/randomize.json:
    post:
      summary: Randomize a tournament's participants
      deprecated: true
      description: >-
        Randomize seeds among participants. Only applicable before a tournament
        has started.
      tags:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1113893/apis/api-23832032-run
components:
  schemas: {}
  securitySchemes:
    api_key:
