  ...
  /tournaments/{tournament}/matches.json:
    get:
      ...
      parameters:
        ...
        - name: state
          in: query
          description: all (default), pending, open, complete
          required: false
          schema:
            type: string
        - name: participant_id
          in: query
          description: Only retrieve matches that include the specified participant.
          required: false
          schema:
            type: string
      responses:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1113893/apis/api-23832273-run
components:
  schemas: {}
  securitySchemes:
    api_key:
