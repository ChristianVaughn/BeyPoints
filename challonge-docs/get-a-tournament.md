...
paths:
  /tournament/{tournament}.json:
    get:
      ...
      deprecated: true
      description: Retrieve a single tournament record created with your account.
      tags:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1113893/apis/api-23824918-run
components:
  schemas: {}
  securitySchemes:
    api_key:
