...
info:
  ...
  version: 1.0.0
paths:
  /tournaments/{tournament}/matches/{match_id}/reopen.json:
    post:
      summary: Reopen a match
      deprecated: true
      description: >-
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1113893/apis/api-23832652-run
components:
  schemas: {}
  securitySchemes:
    api_key:
