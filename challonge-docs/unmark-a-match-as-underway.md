...
info:
  ...
  version: 1.0.0
paths:
  /tournaments/{tournament}/matches/{match_id}/unmark_as_underway.json:
    post:
      summary: Unmark a match as underway
      deprecated: true
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/1113893/apis/api-23832664-run
components:
  schemas: {}
  securitySchemes:
    api_key:
